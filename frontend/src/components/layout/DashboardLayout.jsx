...
const DashboardLayout = ({ children }) => {
  ...
  const myProductsList = [
    ...
    { text: 'Whiteboards', path: '/dashboard', icon: <BrushIcon sx={{ fontSize: 18 }} /> },
    { text: 'Notes', path: '/dashboard', icon: <NoteIcon sx={{ fontSize: 18 }} /> },
    { text: 'Clips', path: '/dashboard', icon: <MovieIcon sx={{ fontSize: 18 }} /> },
    { text: 'Canvas', path: '/dashboard', icon: <DashboardIcon sx={{ fontSize: 18 }} /> },
    { text: 'Paper', path: '/dashboard', icon: <DescriptionIcon sx={{ fontSize: 18 }} /> },
    { text: 'Sheets', path: '/dashboard', icon: <TableChartIcon sx={{ fontSize: 18 }} /> },
    { text: 'Slides', path: '/dashboard', icon: <SlideshowIcon sx={{ fontSize: 18 }} /> },
    { text: 'Tasks', path: '/dashboard', icon: <TaskIcon sx={{ fontSize: 18 }} /> },
